...
const Shuffle: React.FC<ShuffleProps> = ({
      ...
      const play = () => {
        ...
        const tl = gsap.timeline({
          ...
          onRepeat: () => {
            ...
            gsap.set(strips, { x: (_, t: HTMLElement) => Number.parseFloat(t.getAttribute("data-start-x") || "0") });
            onShuffleComplete?.();
          },
          onComplete: () => {
            playingRef.current = false;
        ...
        const addTween = (targets: HTMLElement[], at: number) => {
          tl.to(
            targets,
            {
              x: (_, t: HTMLElement) => Number.parseFloat(t.getAttribute("data-final-x") || "0"),
              duration,
              ease,
              force3D: true,
  ...
  const baseTw =
    "inline-block whitespace-normal break-words will-change-transform text-title-3 md:text-title-2 leading-none";
