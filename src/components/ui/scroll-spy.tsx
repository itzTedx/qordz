...
function ScrollSpyRoot(props: ScrollSpyRootProps) {
  ...
  return (
    <StoreContext.Provider value={store}>
      <ScrollSpyRootImpl defaultValue={defaultValue} value={value} {...rootProps} />
...
function ScrollSpyLink(props: ScrollSpyLinkProps) {
  ...
  return (
    <LinkPrimitive
      ...
      {...linkProps}
      className={cn(
        "rounded-full px-4 py-2 font-medium text-muted-foreground text-sm transition-colors hover:bg-accent hover:text-accent-foreground data-[state=active]:border-primary data-[state=active]:bg-card data-[state=active]:text-foreground data-[state=active]:shadow-sm",
        className
      )}
